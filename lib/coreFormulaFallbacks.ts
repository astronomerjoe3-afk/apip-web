...
const CORE_FORMULA_FALLBACKS: Record<string, FormulaFallbackEntry[]> = {
  ...
  M11_L1: [
    ...
    { standardFormula: "V_total = V1 + V2 + ...", meaning: "The source voltage is shared across series components.", conditions: "Use for a full series chain.", unitsText: "V" },
  ...
  M11_L2: [
    ...
    { standardFormula: "1 / R_total = 1 / R1 + 1 / R2 + ...", meaning: "Parallel branches lower the equivalent resistance of the whole network.", conditions: "Use for resistors in parallel.", unitsText: "1/ohms" },
  ],
  M11_L3: [
    { standardFormula: "P = IV", meaning: "Power is energy transferred each second by a component.", conditions: "Use when current and voltage are known.", unitsText: "W" },
    { standardFormula: "P = I^2 R", meaning: "Power can also be found from current and resistance.", conditions: "Use when current through the component and its resistance are known.", unitsText: "W" },
    { standardFormula: "P = V^2 / R", meaning: "Power can also be found from voltage across a component and its resistance.", conditions: "Use when voltage and resistance are known.", unitsText: "W" },
  ],
  M11_L4: [
    { standardFormula: "series circuit = one uninterrupted path", meaning: "Series and parallel are read from connection logic, not from drawing layout.", conditions: "Use when classifying a network from its paths and junctions.", unitsText: "" },
    { standardFormula: "parallel circuit = branches share the same two junctions", meaning: "Parallel components sit on different branches between the same pair of junctions.", conditions: "Use when classifying a network from its paths and junctions.", unitsText: "" },
  ],
  M11_L5: [
    { standardFormula: "short circuit -> very low resistance -> very large current", meaning: "Unsafe current rises because the circuit resistance becomes too small.", conditions: "Use when explaining overload and fault conditions.", unitsText: "" },
    { standardFormula: "fuse or breaker opens the circuit when current is too large", meaning: "Safety devices protect by breaking the path when current exceeds a safe value.", conditions: "Use when comparing protection devices with insulation.", unitsText: "" },
  ],
  M11_L6: [
    { standardFormula: "R_series = R1 + R2 + ...", meaning: "A valid series block reduces by direct addition.", conditions: "Use when simplifying one series section at a time.", unitsText: "ohms" },
    { standardFormula: "1 / R_parallel = 1 / R1 + 1 / R2 + ...", meaning: "A valid parallel block reduces through the reciprocal rule.", conditions: "Use when simplifying one parallel section at a time.", unitsText: "1/ohms" },
    { standardFormula: "I_total = V / R_total", meaning: "After the network is reduced to one equivalent resistance, total current follows Ohm's law.", conditions: "Use only after the circuit has been reduced to its equivalent resistance.", unitsText: "A" },
  ],
  M12_L1: [
