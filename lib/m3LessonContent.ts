...
const M3_CONCEPT_EXPANSIONS: Record<string, UnknownRecord[]> = {
  ...
  M3_L6: [
    ...
    shortItem("M3L6_C8", "Why is backward planning sometimes helpful in long missions?", ["because the final target can tell you the earlier required input", "because it traces the target back through yields or leaks"], "Use target-backward language.", phraseGroups(["target", "final", "goal"], ["back", "backward", "trace", "work back"], ["input", "required", "earlier", "needed", "store"])),
  ],
};
