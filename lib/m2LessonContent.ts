  ...
  switch (code) {
    case "M2_L1":
      return [
        ...
        mcItem("M2L1_M6", "A craft is moving east but slowing down on a friction-free deck. Which way must the Master Arrow point?", ["west", "east", "north", "it must be zero"], 0, "The Master Arrow points with the acceleration, not necessarily with the current motion.", "If the craft is moving east but slowing down, the acceleration must point west, so the Master Arrow points west."),
