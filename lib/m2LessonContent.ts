...
const M2_VISUAL_META: Record<string, M2QuestionVisualMeta> = {
  ...
  M2L6: {
    ...
    visual_callouts: [
      ...
      "Perpendicular components rebuild geometrically, not by plain number addition.",
    ],
  },
};
...
export function m2GeneratedMasteryItems(code: string): UnknownRecord[] {
  switch (code) {
    ...
    case "M2_L6":
      return [
        shortItem("M2L6_M1", "A force has components 8 N east and 6 N north. What resultant magnitude does that give?", ["10 N", "10"], "Use vector addition: the 8 N east and 6 N north components are perpendicular, so rebuild the diagonal resultant instead of adding 8 + 6."),
        ...
        mcItem("M2L6_M6", "A force has components 12 N east and 5 N north. What resultant magnitude does that give?", ["13 N", "7 N", "17 N", "12 N"], 0, "Use vector addition: 12 N east and 5 N north are perpendicular components, so the diagonal resultant is not 17 N from plain addition.", "The 12 N east and 5 N north components rebuild a 13 N diagonal resultant, because perpendicular components combine geometrically rather than by plain addition."),
...
export function m2ScaffoldMediaCards(code: string): UnknownRecord[] {
  ...
  if (code === "M2_L6") {
    cards.splice(1, 0, {
      ...
      caption: "Tip-to-tail vector addition shows how perpendicular components recreate one diagonal force, and why that differs from plain algebraic addition.",
