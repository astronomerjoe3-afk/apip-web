...
export function m2ScaffoldFocusExtras(code: string): string[] {
  switch (code) {
    case "M2_L1":
      return [
        "Combine Drive Arrows into one Master Arrow before you predict motion.",
        "Zero Master Arrow means zero acceleration, not automatically zero velocity.",
        "Balanced arrows and no arrows can share the same resultant while telling different force stories.",
      ];
    case "M2_L2":
      return [
    ...
    case "M2_L6":
      return [
        "Arrow Split is a reasoning move that rewrites one angled force into components.",
