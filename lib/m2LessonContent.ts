  ...
  switch (code) {
    case "M2_L1":
      return [
        ...
        shortItem("M2L1_D6", "In a few words, what does zero Master Arrow mean?", ["zero acceleration", "no motion change", "motion stays unchanged", "constant velocity if already moving"], "Zero Master Arrow tells you about acceleration, not about one special speed value."),
    ...
    case "M2_L5":
      return [
        ...
        shortItem("M2L5_D6", "If cargo is moved to the right, which way does the Balance Core shift?", ["right", "to the right"], "The Balance Core shifts toward the moved mass."),
  ...
  switch (code) {
    case "M2_L1":
      return [
        ...
        shortItem("M2L1_M3", "A craft has 13 N right and 8 N left. What Master Arrow remains?", ["5 N right", "5 right", "5 N"], "Subtract opposite arrows and keep the direction of the larger side."),
        mcItem("M2L1_M4", "Which pair can share the same Master Arrow?", ["8 N right and 3 N left, or 5 N right only", "8 N right only, or 8 N left only", "4 N right and 4 N left, or 2 N right only", "10 N left and 4 N right, or 10 N right and 4 N left"], 0, "Compare the net push in each case.", "8 N right with 3 N left leaves 5 N right, which matches a single 5 N right Master Arrow."),
        mcItem("M2L1_M5", "A craft has no Drive Arrows acting at all. Which claim is strongest?", ["the Master Arrow is zero, but the craft could still be moving steadily", "the craft must be at rest", "the craft must accelerate backward", "balanced forces are acting"], 0, "Zero force still allows constant velocity.", "With no Drive Arrows acting, the Master Arrow is zero, but the craft could still be moving steadily if no force is changing its motion."),
        mcItem("M2L1_M6", "A craft has 4 N north, 4 N south, and 9 N east. What Master Arrow remains?", ["9 N east", "5 N east", "13 N east", "0 N"], 0, "Cancel opposite vertical arrows first.", "The north and south arrows cancel, leaving a 9 N east Master Arrow."),
        shortItem("M2L1_M7", "In a few words, what does zero Master Arrow mean?", ["zero acceleration", "no motion change", "motion stays unchanged", "constant velocity if already moving"], "Zero Master Arrow tells you about motion change, not about one special velocity."),
        mcItem("M2L1_M8", "A craft is speeding up west. Which statement must be true?", ["the Master Arrow points west", "the craft must have no forces acting", "the Master Arrow points east", "the craft must be slowing down"], 0, "Acceleration points with the resultant force.", "If the craft is speeding up west, the Master Arrow must point west."),
      ];
    case "M2_L2":
      return [
    ...
    case "M2_L5":
      return [
        ...
        shortItem("M2L5_M2", "Cargo is moved to the left side of the craft. Which way does the Balance Core shift?", ["left"], "The Balance Core shifts toward the moved mass."),
