...
const MODULE_TECHNICAL_WORDS: Record<string, TechnicalWordSeed[]> = {
  ...
  M14: [
    { term: "Orbit", aliases: ["orbit", "orbits"], meaning: "An orbit is the curved path one body follows around another because of gravity.", why_it_matters: "It explains planetary years, moon motion, and changing viewpoints." },
    { term: "Rotation", aliases: ["rotation", "rotates"], meaning: "Rotation is the spinning of an object about its own axis.", why_it_matters: "It explains day and night more directly than orbit does." },
    { term: "Revolution", aliases: ["revolution", "revolve"], meaning: "Revolution is motion around another body along an orbit.", why_it_matters: "It helps separate 'spins on itself' from 'goes around something else'." },
    { term: "Axis", aliases: ["axis"], meaning: "An axis is the imaginary line about which an object rotates.", why_it_matters: "Tilt and rotation about the axis shape many astronomy patterns." },
    { term: "Moon phase", aliases: ["phase", "moon phase", "phases"], meaning: "A moon phase is the visible shape of the lit part of the Moon as seen from Earth.", why_it_matters: "Phases come from changing viewpoint, not from Earth's shadow in the ordinary cycle." },
    { term: "Eclipse", aliases: ["eclipse", "eclipses"], meaning: "An eclipse happens when one astronomical body moves into the shadow of another or blocks its light.", why_it_matters: "It is a special alignment event, not the normal explanation for phases." },
    { term: "Planet", aliases: ["planet", "planets"], meaning: "A planet is a large body that orbits a star and does not make its own light by fusion.", why_it_matters: "It keeps planets separate from stars and moons." },
    { term: "Solar System", aliases: ["solar system"], meaning: "The Solar System is the Sun and the bodies held by its gravity.", why_it_matters: "It is smaller than a galaxy and larger than one planet's local system." },
  ],
  M15: [
