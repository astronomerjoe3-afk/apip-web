...
const MODULE_TECHNICAL_WORDS: Record<string, TechnicalWordSeed[]> = {
  ...
  M3: [
    { term: "Energy store", aliases: ["energy store", "store"], meaning: "An energy store is a way energy is held in a system, such as motion store or height store.", why_it_matters: "It stops learners from treating energy as a vague substance with no location." },
    ...
    { term: "Gravitational field strength", aliases: ["gravitational field strength", "g"], meaning: "Gravitational field strength is the pull per kilogram at a location, often measured in newtons per kilogram.", why_it_matters: "It keeps the g factor visible in the mgh relation instead of collapsing the story into height alone." },
    ...
    { term: "Useful output", aliases: ["useful output", "useful energy output"], meaning: "Useful output is the part of the input that ends up in the wanted store or effect.", why_it_matters: "It is the numerator in an efficiency calculation." },
    { term: "Wasted energy", aliases: ["wasted energy", "waste", "leak trail"], meaning: "Wasted energy is the part of the input that spreads out in less useful ways instead of becoming the intended output.", why_it_matters: "It keeps the energy ledger balanced when the useful gain is smaller than the input." },
  ...
  M4: [
    ...
    { term: "Hydrostatic pressure", aliases: ["hydrostatic pressure", "liquid pressure"], meaning: "Hydrostatic pressure is the pressure produced by a resting liquid because of the liquid above the point.", why_it_matters: "It keeps the rho g h story tied to depth, density, and gravitational field strength." },
    { term: "Gravitational field strength", aliases: ["gravitational field strength", "g"], meaning: "Gravitational field strength is the pull per kilogram at a location.", why_it_matters: "It is one of the three direct factors in liquid pressure." },
    { term: "Surface normal", aliases: ["surface normal", "normal"], meaning: "The surface normal is the perpendicular direction to a surface.", why_it_matters: "Force due to pressure acts along the surface normal." },
    { term: "Total pressure", aliases: ["total pressure"], meaning: "Total pressure in an open liquid is the sum of atmospheric pressure and the liquid contribution.", why_it_matters: "It stops learners from treating rho g h as the full answer in open-surface questions." },
  ...
  M5: [
    ...
    { term: "Average kinetic energy", aliases: ["average kinetic energy"], meaning: "Average kinetic energy is the mean motion-energy value for the particles in a sample.", why_it_matters: "It is the M5 bridge between particle motion and temperature." },
    ...
    { term: "Particle attraction", aliases: ["particle attraction", "attraction", "attractions"], meaning: "Particle attraction is the pull between neighboring particles in the model.", why_it_matters: "It helps explain why solids hold shape, why liquids stay close-packed, and why state changes need energy." },
    { term: "State change", aliases: ["state change", "change of state"], meaning: "A state change is a transition such as melting or boiling in which the arrangement of particles changes.", why_it_matters: "It separates temperature rise from arrangement change in the internal-energy story." },
    { term: "Melting", aliases: ["melting"], meaning: "Melting is the change of state from solid to liquid.", why_it_matters: "It is the first state-boundary example where added energy can go strongly into changing arrangement." },
    { term: "Boiling", aliases: ["boiling"], meaning: "Boiling is the change of state from liquid to gas throughout the liquid.", why_it_matters: "It is the clearest case where internal energy can rise while temperature changes only a little." },
  ],
  M6: [
  ...
  M8: [
    ...
    { term: "Angle of incidence", aliases: ["angle of incidence", "incident angle"], meaning: "The angle of incidence is the angle between the incident ray and the normal.", why_it_matters: "It is the angle used in the laws of reflection and refraction." },
    ...
    { term: "Refracted ray", aliases: ["refracted ray", "refracted route"], meaning: "The refracted ray is the ray that enters the second medium after changing direction at a boundary.", why_it_matters: "Its direction shows whether the light sped up or slowed down." },
    ...
    { term: "Converging lens", aliases: ["converging lens", "convex lens", "gather lens"], meaning: "A converging lens bends parallel rays toward a meeting point on the far side.", why_it_matters: "It is the standard lens used to form real images and focus light." },
    { term: "Diverging lens", aliases: ["diverging lens", "concave lens", "spread lens"], meaning: "A diverging lens spreads parallel rays so they appear to come from a focus on the object side.", why_it_matters: "It explains why the usual image is virtual, upright, and smaller." },
    ...
    { term: "Ray diagram", aliases: ["ray diagram", "ray diagrams", "route sketch"], meaning: "A ray diagram is a selected set of rays used to predict where an image forms.", why_it_matters: "It works only if real rays, guide lines, and dashed extensions keep their distinct roles." },
    ...
    { term: "Optical fibre", aliases: ["optical fibre", "optical fiber", "fibre optic"], meaning: "An optical fibre is a thin transparent guide that keeps light inside by repeated total internal reflection.", why_it_matters: "It is the practical application that turns the critical-angle rule into a real device story." },
  ],
  M9: [
